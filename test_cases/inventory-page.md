...
| [TC-INVENTORY-005](#tc-inventory-005--product-can-be-added-to-cart-from-inventory-page)                                     | Product can be added to cart from inventory page                                     | Smoke / Navigation      | High     | Automated         | `tests/test_inventory_page.py` |
