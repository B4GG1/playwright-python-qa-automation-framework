...
| [TC-INVENTORY-004](#tc-inventory-004--product-details-can-be-opened-from-product-name)        | Product details can be opened from product name           | Regression / Positive | Medium   | Planned           | TBD          |
| [TC-INVENTORY-005](#tc-inventory-005--product-details-can-be-opened-from-product-image)       | Product details can be opened from product image          | Regression / Positive | Medium   | Planned           | TBD          |
| [TC-INVENTORY-006](#tc-inventory-006--user-can-return-from-product-details-to-inventory-page) | User can return from product details to inventory page    | Regression / Positive | Medium   | Planned           | TBD          |
...
1. Log in with valid credentials.
2. Click a product name on the inventory page.
...
* Product details page displays product price.
* Product details page displays product image.
...
1. Log in with valid credentials.
2. Click a product image on the inventory page.

**Expected Result:**

* Product details page is opened.
* Product details page displays the selected product.
* Product details page content matches the selected product.

**Notes:**

* This scenario validates product details navigation from product image.
* This can reuse the same example product as the product name navigation scenario.
